...
-- 设备维修执行
INSERT INTO dhlk_app_menu VALUES (1023, '/devRepair/programmeImplement', '设备维修任务执行', '/devRepair/programmeImplement', 0, 38, '/devRepair:programmeImplement', 0,'fwDevice');
...
INSERT INTO dhlk_app_menu VALUES (1025, 'programmeImplement/edit', '制定', 'programmeImplement/edit', 0, 1024, 'devicesRepair:makeProject', 1,'fwDevice');
INSERT INTO dhlk_app_menu VALUES (1026, 'programmeImplement/delete', '删除', 'programmeImplement/delete', 0, 1024, 'devicesRepair:delete', 1,'fwDevice');
INSERT INTO dhlk_app_menu VALUES (1027, 'programmeImplement/get', '领取', 'programmeImplement/get', 0, 1024, 'devicesRepair:getTask', 1,'fwDevice');
INSERT INTO dhlk_app_menu VALUES (1028, 'programmeImplement/go', '执行', 'programmeImplement/go', 0, 1024, 'devicesRepair:repairTaskExecute', 1,'fwDevice');
INSERT INTO dhlk_app_menu VALUES (1029, 'programmeImplement/find', '查看', 'programmeImplement/find', 0, 1024, 'devicesRepair:findList', 1,'fwDevice');
...
INSERT INTO dhlk_app_menu VALUES (1506, 'inventory/add', '新建', 'inventory/add', 0, 1505, 'inventory:insert', 1,'fwLogistics');
INSERT INTO dhlk_app_menu VALUES (1507, 'inventory/edit', '盘库', 'inventory/edit', 0, 1505, 'inventory:update', 1,'fwLogistics');
INSERT INTO dhlk_app_menu VALUES (1508, 'inventory/close', '关闭', 'inventory/updateStatus', 0, 1505, 'inventory:update', 1,'fwLogistics');
INSERT INTO dhlk_app_menu VALUES (1509, 'inventory/find', '查看', 'inventory/find', 0, 1505, 'inventory:find', 1,'fwLogistics');
...
INSERT INTO dhlk_app_menu VALUES (1668, '/warehouseOutManage/warehouseOut', '出库管理', '/warehouseOutManage/warehouseOut', 0, 1567, 'warehousingManage:view', 0,'fwLogistics');

/**质量管理**/

-- 首末件管理
INSERT INTO dhlk_app_menu VALUES (1060, '/qualityTask', '质量管理', '/qualityTask', 0, 0, 'dhlk:view', 0,'fwQulity');
-- 质量首末检管理
INSERT INTO dhlk_app_menu VALUES (1061, '/qualityTask/firstLastTest', '质量首末检管理', '/qualityTask/firstLastTest', 0, 1060, 'dhlk:view', 0,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1062, '/firstLastTest/submit', '提交质检结果', '/firstLastTest/submit', 0, 1061, 'qualityFirstendCheck:submit', 1,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1063, '/firstLastTest/update', '更新质检结果', '/firstLastTest/update', 0, 1061, 'qualityFirstendCheck:update', 1,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1064, '/firstLastTest/coerceClose', '强制关闭', '/firstLastTest/coerceClose', 0, 1061, 'qualityFirstendCheck:coerceClose', 1,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1065, '/firstLastTest/postponeExe', '延期执行', '/firstLastTest/postponeExe', 0, 1061, 'qualityFirstendCheck:postponeExe', 1,'fwQulity');
-- 来料检验管理
INSERT INTO dhlk_app_menu VALUES (1066, '/qualityTask/incomingTest', '来料检验管理', '/qualityTask/incomingTest', 0, 1060, 'dhlk:view', 0,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1067, '/incomingTest/submit', '提交质检结果', '/incomingTest/submit', 0, 1066, 'qualityMaterialCheck:submit', 1,'fwQulity');
-- 出库检验管理
INSERT INTO dhlk_app_menu VALUES (1068, '/qualityTask/outhousingTest', '出库检验管理', '/qualityTask/outhousingTest', 0, 1060, 'dhlk:view', 0,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1069, '/outhousingTest/submit', '提交质检结果', '/outhousingTest/submit', 0, 1068, 'qualityOutCheck:submit', 1,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1070, '/outhousingTest/update', '更新质检结果', '/outhousingTest/update', 0, 1068, 'qualityOutCheck:update', 1,'fwQulity');
-- 入库检验管理
INSERT INTO dhlk_app_menu VALUES (1071, '/qualityTask/warehousingTest', '入库检验管理', '/qualityTask/warehousingTest', 0, 1060, 'dhlk:view', 0,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1072, '/warehousingTest/submit', '提交质检结果', '/outhousingTest/submit', 0, 1071, 'qualityStoreCheck:submit', 1,'fwQulity');
INSERT INTO dhlk_app_menu VALUES (1073, '/warehousingTest/update', '更新质检结果', '/outhousingTest/update', 0, 1071, 'qualityStoreCheck:update', 1,'fwQulity');
...
INSERT INTO dhlk_app_menu VALUES (1074, '/processManage', '工艺管理', '/processManage', 0, 0, 'dhlk:view', 0,'fwCraft');
INSERT INTO dhlk_app_menu VALUES (1075, '/processManage/processManage', '工艺模型管理', '/processManage/processManage', 0, 1074, 'dhlk:view', 0,'fwCraft');

INSERT INTO dhlk_app_menu VALUES (1076, '/processManage/add', '新增', '/processManage/add', 0, 1075, 'craftModel:save', 1,'fwCraft');
INSERT INTO dhlk_app_menu VALUES (1077, '/processManage/edit', '修改', '/processManage/edit', 0, 1075, 'craftModel:save', 1,'fwCraft');
INSERT INTO dhlk_app_menu VALUES (1078, '/processManage/delete', '删除', '/processManage/delete', 0, 1075, 'craftModel:delete', 1,'fwCraft');
...
INSERT INTO dhlk_app_menu VALUES (1670, '/warehousingPro/warehousingPro', '生产入库', '/warehousingPro/warehousingPro', 0, 1569, 'warehousingPro:view', 0,'fwProduce');
...
INSERT INTO dhlk_app_menu VALUES (1672, 'logisticsStoreHouse/delete', '删除', 'logisticsStoreHouse/delete', 0, 1670, 'logisticsStoreHouse:save', 1,'fwProduce');
...
INSERT INTO dhlk_app_menu VALUES (1502, 'customers/add', '新建仓库', 'customers/add', 0, 1501, 'customer:save', 1,'fwPlan');
INSERT INTO dhlk_app_menu VALUES (1503, 'customers/edit', '编辑仓库', 'customers/edit', 0, 1501, 'customer:save', 1,'fwPlan');
