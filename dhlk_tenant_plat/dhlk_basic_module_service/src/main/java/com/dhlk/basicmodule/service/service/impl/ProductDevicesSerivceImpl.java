...
public class ProductDevicesSerivceImpl implements ProductDevicesService {
    ...
    public Result findList(String name,String classifyId) {
        return ResultUtils.success(productDevicesDao.findList(name,authUserUtil.tenantId(),attachmentPath,classifyId));
    }
    ...
    public Result findListByTenantId(Integer tenantId, String token) {
        ...
        List<ProductDevices> list = productDevicesDao.findListByTenantId(tenantId);
        return ResultUtils.success(list);
    }
    ...
    public Result getDevice(Integer id) {
        ...
        ProductDevices productDevices = productDevicesDao.getDevice(id);
        return ResultUtils.success(productDevices);
    }
