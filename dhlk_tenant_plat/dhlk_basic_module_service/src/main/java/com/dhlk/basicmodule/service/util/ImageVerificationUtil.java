...
//        int VERIFICATION_IMAGE_HEIGHT = verificationImage.getHeight();
     ...
     * @return
     */
    public static ImageVerificationVo pictureTemplateCutout(File originImageFile, String originImageFileType, File templateImageFile, String templateImageFileType, int x, int y) throws MyException {
        ImageVerificationVo imageVerificationVo = null;
...
//                    shadeImage.setRGB(x + i, y + j, originRGB);
     ...
     * @return
     */
    private static BufferedImage getInterestArea(int x, int y, int templateImageWidth, int templateImageHeight, File originImage, String originImageType) throws MyException {
     ...
     * @return 图片容器
     */
    public static ImageVerificationVo cutoutImageEdge(ImageVerificationVo imageVerificationVo, BufferedImage borderImage, String borderImageFileType) throws MyException {
